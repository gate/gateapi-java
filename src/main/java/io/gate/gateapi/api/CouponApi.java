...
import io.gate.gateapi.models.GetUserCouponDetailResponse;
import io.gate.gateapi.models.ListUserCouponsResponse;
...
public class CouponApi {
    ...
    private okhttp3.Call listUserCouponsCall(Integer expired, Integer limit, Integer lastId, Integer expireTime, String orderBy, String type, Integer isTaskCoupon, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/coupon/user-coupon-list";
        ...
        if (isTaskCoupon != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("is_task_coupon", isTaskCoupon));
        }
    ...
    private okhttp3.Call listUserCouponsValidateBeforeCall(Integer expired, Integer limit, Integer lastId, Integer expireTime, String orderBy, String type, Integer isTaskCoupon, final ApiCallback _callback) throws ApiException {
        okhttp3.Call localVarCall = listUserCouponsCall(expired, limit, lastId, expireTime, orderBy, type, isTaskCoupon, _callback);
        return localVarCall;
    }


    private ApiResponse<ListUserCouponsResponse> listUserCouponsWithHttpInfo(Integer expired, Integer limit, Integer lastId, Integer expireTime, String orderBy, String type, Integer isTaskCoupon) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ListUserCouponsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listUserCouponsAsync(Integer expired, Integer limit, Integer lastId, Integer expireTime, String orderBy, String type, Integer isTaskCoupon, final ApiCallback<ListUserCouponsResponse> _callback) throws ApiException {
    ...
    public class APIlistUserCouponsRequest {
        ...
        private String type;
        private Integer isTaskCoupon;

        private APIlistUserCouponsRequest() {
        }

        /**
         * Set expired
         * @param expired Coupon status filter. &#x60;0&#x60; &#x3D; query valid coupons (default); &#x60;1&#x60; &#x3D; query expired/used coupons (optional, default to 0)
         * @return APIlistUserCouponsRequest
         */
        public APIlistUserCouponsRequest expired(Integer expired) {
        ...
        /**
         * Set limit
         * @param limit Number of coupons returned per page, range 1-20, default 10 (optional, default to 10)
         * @return APIlistUserCouponsRequest
         */
        public APIlistUserCouponsRequest limit(Integer limit) {
            this.limit = limit;
            return this;
        }
        ...
        /**
         * Set lastId
         * @param lastId Cursor-based pagination: the &#x60;id&#x60; value of the last record from the previous page, omit (or pass 0) for the first page (optional)
         * @return APIlistUserCouponsRequest
         */
        public APIlistUserCouponsRequest lastId(Integer lastId) {
            this.lastId = lastId;
            return this;
        }
        ...
        /**
         * Set expireTime
         * @param expireTime Cursor-based pagination: used together with &#x60;last_id&#x60;, pass the &#x60;expire_time_order_by&#x60; value of the last record from the previous page (Unix timestamp), omit for the first page (optional)
         * @return APIlistUserCouponsRequest
         */
        public APIlistUserCouponsRequest expireTime(Integer expireTime) {
        ...
        /**
         * Set orderBy
         * @param orderBy Sort order. &#x60;latest&#x60; &#x3D; by latest claim time descending (default); &#x60;expired&#x60; &#x3D; by expiration time ascending (optional, default to latest)
         * @return APIlistUserCouponsRequest
         */
        public APIlistUserCouponsRequest orderBy(String orderBy) {
        ...
        /**
         * Set isTaskCoupon
         * @param isTaskCoupon Task Coupon Filter. &#x60;0&#x60; &#x3D; Return only regular coupons; &#x60;1&#x60; &#x3D; Return only task coupons; Omit to return both (optional)
         * @return APIlistUserCouponsRequest
         */
        public APIlistUserCouponsRequest isTaskCoupon(Integer isTaskCoupon) {
            this.isTaskCoupon = isTaskCoupon;
            return this;
        }

        /**
         * Build call for listUserCoupons
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return listUserCouponsCall(expired, limit, lastId, expireTime, orderBy, type, isTaskCoupon, _callback);
        }
         ...
         */
        public ListUserCouponsResponse execute() throws ApiException {
            ApiResponse<ListUserCouponsResponse> localVarResp = listUserCouponsWithHttpInfo(expired, limit, lastId, expireTime, orderBy, type, isTaskCoupon);
            return localVarResp.getData();
        }

        /**
         * Execute listUserCoupons request with HTTP info returned
         * @return ApiResponse&lt;ListUserCouponsResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ListUserCouponsResponse> executeWithHttpInfo() throws ApiException {
            return listUserCouponsWithHttpInfo(expired, limit, lastId, expireTime, orderBy, type, isTaskCoupon);
        }

        /**
         * Execute listUserCoupons request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ListUserCouponsResponse> _callback) throws ApiException {
     ...
     */
    public APIlistUserCouponsRequest listUserCoupons() {
        return new APIlistUserCouponsRequest();
    }

    private okhttp3.Call getUserCouponDetailCall(String couponType, Integer detailId, Integer isTaskCoupon, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/coupon/user-coupon-detail";
        ...
        if (detailId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("detail_id", detailId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserCouponDetailValidateBeforeCall(String couponType, Integer detailId, Integer isTaskCoupon, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'couponType' is set
        if (couponType == null) {
            throw new ApiException("Missing the required parameter 'couponType' when calling getUserCouponDetail(Async)");
        }

        // verify the required parameter 'detailId' is set
        if (detailId == null) {
            throw new ApiException("Missing the required parameter 'detailId' when calling getUserCouponDetail(Async)");
        }

        okhttp3.Call localVarCall = getUserCouponDetailCall(couponType, detailId, isTaskCoupon, _callback);
        return localVarCall;
    }


    private ApiResponse<GetUserCouponDetailResponse> getUserCouponDetailWithHttpInfo(String couponType, Integer detailId, Integer isTaskCoupon) throws ApiException {
        okhttp3.Call localVarCall = getUserCouponDetailValidateBeforeCall(couponType, detailId, isTaskCoupon, null);
        Type localVarReturnType = new TypeToken<GetUserCouponDetailResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getUserCouponDetailAsync(String couponType, Integer detailId, Integer isTaskCoupon, final ApiCallback<GetUserCouponDetailResponse> _callback) throws ApiException {
    ...
    public class APIgetUserCouponDetailRequest {
        private final String couponType;
        private final Integer detailId;
        private Integer isTaskCoupon;

        private APIgetUserCouponDetailRequest(String couponType, Integer detailId) {
        ...
        /**
         * Set isTaskCoupon
         * @param isTaskCoupon Coupon source type. &#x60;0&#x60; &#x3D; regular coupon (default); &#x60;1&#x60; &#x3D; task coupon. This parameter determines the query logic for &#x60;detail_id&#x60; (optional, default to 0)
         * @return APIgetUserCouponDetailRequest
         */
        public APIgetUserCouponDetailRequest isTaskCoupon(Integer isTaskCoupon) {
            this.isTaskCoupon = isTaskCoupon;
            return this;
        }

        /**
         * Build call for getUserCouponDetail
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return getUserCouponDetailCall(couponType, detailId, isTaskCoupon, _callback);
        }
         ...
         */
        public GetUserCouponDetailResponse execute() throws ApiException {
            ApiResponse<GetUserCouponDetailResponse> localVarResp = getUserCouponDetailWithHttpInfo(couponType, detailId, isTaskCoupon);
            return localVarResp.getData();
        }

        /**
         * Execute getUserCouponDetail request with HTTP info returned
         * @return ApiResponse&lt;GetUserCouponDetailResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<GetUserCouponDetailResponse> executeWithHttpInfo() throws ApiException {
            return getUserCouponDetailWithHttpInfo(couponType, detailId, isTaskCoupon);
        }

        /**
         * Execute getUserCouponDetail request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<GetUserCouponDetailResponse> _callback) throws ApiException {
     ...
     * @param couponType Coupon type enum. If not specified, all supported types are returned. Available values: &#x60;position_voucher&#x60; (position voucher), &#x60;tradfi_position_voucher&#x60; (TradFi position voucher), &#x60;contract_bonus&#x60; (futures bonus), &#x60;contract_bonus_new&#x60; (futures trial coupon), &#x60;commission_rebate&#x60; (commission rebate coupon), &#x60;hold_bonus&#x60; (earn trial bonus), &#x60;point&#x60; (point card), &#x60;financial_rate&#x60; (interest rate boost coupon), &#x60;robot_bonus&#x60; (trading bot bonus), &#x60;loss_protection_copier&#x60; (copy trading loss protection), &#x60;vip_card&#x60; (VIP trial card), &#x60;interest_voucher&#x60; (margin interest discount coupon), &#x60;p2p&#x60; (P2P trading deduction coupon), &#x60;cash&#x60; (cash coupon), &#x60;crypto_loan_interest&#x60; (crypto loan interest discount coupon), &#x60;copy_trading&#x60; (copy trading bonus), &#x60;alpha_voucher&#x60; (Alpha cash coupon), &#x60;etf_voucher&#x60; (ETF trial bonus) (required)
     * @param detailId Coupon ID. **Regular coupon**: pass &#x60;details_id&#x60; from the list (primary key of each type&#39;s user coupon table); **Task coupon**: pass &#x60;id&#x60; from the list (primary key of the distribution record table) (required)
     * @return APIgetUserCouponDetailRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIgetUserCouponDetailRequest getUserCouponDetail(String couponType, Integer detailId) {
        return new APIgetUserCouponDetailRequest(couponType, detailId);
    }
