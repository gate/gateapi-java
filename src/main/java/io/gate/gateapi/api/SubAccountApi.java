...
public class SubAccountApi {
    ...
    public class APIlistSubAccountsRequest {
        ...
        /**
         * Set type
         * @param type Enter &#x60;0&#x60; to list all types of sub-accounts (currently supporting cross-margin sub-accounts and regular sub-accounts). Enter &#x60;1&#x60; to query regular sub-accounts only. If no parameter is passed, only regular sub-accounts will be queried by default. (optional)
    ...
    /**
     * List all API key pairs of the sub-account (asynchronously)
     * 
     * @param userId Sub-account user ID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Create new sub-account API key pair (asynchronously)
     * 
     * @param userId Sub-account user ID (required)
     * @param subAccountKey  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createSubAccountKeysAsync(Long userId, SubAccountKey subAccountKey, final ApiCallback<SubAccountKey> _callback) throws ApiException {
    ...
    /**
     * Get specific API key pair of the sub-account (asynchronously)
     * 
     * @param userId Sub-account user ID (required)
     * @param key Sub-account API key (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Delete sub-account API key pair (asynchronously)
     * 
     * @param userId Sub-account user ID (required)
     * @param key Sub-account API key (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Locked successfully </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Lock sub-account (asynchronously)
     * 
     * @param userId Sub-account user ID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Unlocked successfully </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Unlock sub-account (asynchronously)
     * 
     * @param userId Sub-account user ID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
