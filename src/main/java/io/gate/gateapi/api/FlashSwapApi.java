...
public class FlashSwapApi {
    ...
    public class APIlistFlashSwapCurrencyPairRequest {
        ...
        /**
         * Set limit
         * @param limit Maximum number of items returned. Default: 1000, minimum: 1, maximum: 1000 (optional, default to 1000)
         * @return APIlistFlashSwapCurrencyPairRequest
         */
    ...
    public class APIlistFlashSwapOrdersRequest {
        ...
        /**
         * Set status
         * @param status Flash swap order status  &#x60;1&#x60; - success &#x60;2&#x60; - failed (optional)
        ...
        /**
         * Set sellCurrency
         * @param sellCurrency Asset name to sell - Retrieved from API &#x60;GET /flash_swap/currencies&#x60; for supported flash swap currencies (optional)
         * @return APIlistFlashSwapOrdersRequest
         */
        ...
        /**
         * Set buyCurrency
         * @param buyCurrency Asset name to buy - Retrieved from API &#x60;GET /flash_swap/currencies&#x60; for supported flash swap currencies (optional)
         * @return APIlistFlashSwapOrdersRequest
         */
        ...
        /**
         * Set reverse
         * @param reverse Sort by ID in ascending or descending order, default &#x60;true&#x60; - &#x60;true&#x60;: ID descending order (most recent data first) - &#x60;false&#x60;: ID ascending order (oldest data first) (optional)
         * @return APIlistFlashSwapOrdersRequest
         */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Flash swap order created successfully </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Query single flash swap order (asynchronously)
     * 
     * @param orderId Flash swap order ID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Flash swap order preview successful </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Flash swap order preview (asynchronously)
     * 
     * @param flashSwapPreviewRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
