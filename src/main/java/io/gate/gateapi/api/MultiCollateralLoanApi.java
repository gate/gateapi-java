...
public class MultiCollateralLoanApi {
    ...
    public class APIlistMultiCollateralOrdersRequest {
        ...
        /**
         * Set limit
         * @param limit Maximum number of records returned in a single list (optional, default to 10)
         * @return APIlistMultiCollateralOrdersRequest
         */
    ...
    /**
     * Place multi-currency collateral order (asynchronously)
     * 
     * @param createMultiCollateralOrder  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Order details queried successfully </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Multi-currency collateral repayment (asynchronously)
     * 
     * @param repayMultiLoan  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIlistMultiCollateralRecordsRequest {
         ...
         * @param collateralCurrency Collateral currency (optional)
         * @return APIlistMultiCollateralRecordsRequest
         */
    ...
    /**
     * Add or withdraw collateral (asynchronously)
     * 
     * @param collateralAdjust  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Query collateralization ratio information (asynchronously)
     * Multi-currency collateral ratio is fixed, independent of currency
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
    ...
    /**
     * Query currency&#39;s 7-day and 30-day fixed interest rates (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
    ...
    private okhttp3.Call getMultiCollateralCurrentRateCall(List<String> currencies, String vipLevel, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (vipLevel != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("vip_level", vipLevel));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMultiCollateralCurrentRateValidateBeforeCall(List<String> currencies, String vipLevel, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getMultiCollateralCurrentRateCall(currencies, vipLevel, _callback);
        return localVarCall;
    }
    ...
    private ApiResponse<List<CollateralCurrentRate>> getMultiCollateralCurrentRateWithHttpInfo(List<String> currencies, String vipLevel) throws ApiException {
        okhttp3.Call localVarCall = getMultiCollateralCurrentRateValidateBeforeCall(currencies, vipLevel, null);
        Type localVarReturnType = new TypeToken<List<CollateralCurrentRate>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getMultiCollateralCurrentRateAsync(List<String> currencies, String vipLevel, final ApiCallback<List<CollateralCurrentRate>> _callback) throws ApiException {
        okhttp3.Call localVarCall = getMultiCollateralCurrentRateValidateBeforeCall(currencies, vipLevel, _callback);
        Type localVarReturnType = new TypeToken<List<CollateralCurrentRate>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetMultiCollateralCurrentRateRequest {
        ...
        /**
         * Set vipLevel
         * @param vipLevel VIP level, defaults to 0 if not specified (optional, default to &quot;0&quot;)
        ...
        /**
         * Build call for getMultiCollateralCurrentRate
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return getMultiCollateralCurrentRateCall(currencies, vipLevel, _callback);
        }

        /**
         * Execute getMultiCollateralCurrentRate request
         * @return List&lt;CollateralCurrentRate&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public List<CollateralCurrentRate> execute() throws ApiException {
            ApiResponse<List<CollateralCurrentRate>> localVarResp = getMultiCollateralCurrentRateWithHttpInfo(currencies, vipLevel);
            return localVarResp.getData();
        }

        /**
         * Execute getMultiCollateralCurrentRate request with HTTP info returned
         * @return ApiResponse&lt;List&lt;CollateralCurrentRate&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public ApiResponse<List<CollateralCurrentRate>> executeWithHttpInfo() throws ApiException {
            return getMultiCollateralCurrentRateWithHttpInfo(currencies, vipLevel);
        }

        /**
         * Execute getMultiCollateralCurrentRate request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<CollateralCurrentRate>> _callback) throws ApiException {
            return getMultiCollateralCurrentRateAsync(currencies, vipLevel, _callback);
        }
    }
