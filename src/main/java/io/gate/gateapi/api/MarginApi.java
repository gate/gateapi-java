...
public class MarginApi {
    ...
    public class APIlistMarginAccountBookRequest {
        ...
        /**
         * Set currency
         * @param currency Query history for specified currency. If &#x60;currency&#x60; is specified, &#x60;currency_pair&#x60; must also be specified. (optional)
        ...
        /**
         * Set currencyPair
         * @param currencyPair Specify margin account currency pair. Used in combination with &#x60;currency&#x60;. Ignored if &#x60;currency&#x60; is not specified (optional)
         * @return APIlistMarginAccountBookRequest
         */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> User&#39;s current auto repayment settings </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Query user auto repayment settings (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     * @param status Whether to enable auto repayment: &#x60;on&#x60; - enabled, &#x60;off&#x60; - disabled (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Update user auto repayment settings (asynchronously)
     * 
     * @param status Whether to enable auto repayment: &#x60;on&#x60; - enabled, &#x60;off&#x60; - disabled (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Set user market leverage multiplier (asynchronously)
     * 
     * @param marginMarketLeverage  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIlistCrossMarginLoansRequest {
        ...
        /**
         * Set currency
         * @param currency Query by specified currency, includes all currencies if not specified (optional)
