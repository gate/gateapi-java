...
import io.gate.gateapi.models.AccountTransferDetail;
...
public class WalletApi {
    ...
    private okhttp3.Call listWithdrawalsCall(String currency, String withdrawId, String assetClass, String withdrawOrderId, Long from, Long to, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (withdrawId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("withdraw_id", withdrawId));
        }
        ...
        if (withdrawOrderId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("withdraw_order_id", withdrawOrderId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listWithdrawalsValidateBeforeCall(String currency, String withdrawId, String assetClass, String withdrawOrderId, Long from, Long to, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        okhttp3.Call localVarCall = listWithdrawalsCall(currency, withdrawId, assetClass, withdrawOrderId, from, to, limit, offset, _callback);
        return localVarCall;
    }
    ...
    private ApiResponse<List<WithdrawalRecord>> listWithdrawalsWithHttpInfo(String currency, String withdrawId, String assetClass, String withdrawOrderId, Long from, Long to, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = listWithdrawalsValidateBeforeCall(currency, withdrawId, assetClass, withdrawOrderId, from, to, limit, offset, null);
        Type localVarReturnType = new TypeToken<List<WithdrawalRecord>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listWithdrawalsAsync(String currency, String withdrawId, String assetClass, String withdrawOrderId, Long from, Long to, Integer limit, Integer offset, final ApiCallback<List<WithdrawalRecord>> _callback) throws ApiException {
        okhttp3.Call localVarCall = listWithdrawalsValidateBeforeCall(currency, withdrawId, assetClass, withdrawOrderId, from, to, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<List<WithdrawalRecord>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIlistWithdrawalsRequest {
        ...
        /**
         * Set currency
         * @param currency Specify the currency. If not specified, returns all currencies (optional)
        ...
        /**
         * Set withdrawId
         * @param withdrawId Withdrawal record ID starts with &#39;w&#39;, such as: w1879219868. When withdraw_id is not empty, only this specific withdrawal record will be queried, and time-based querying will be disabled (optional)
         * @return APIlistWithdrawalsRequest
         */
        ...
        /**
         * Set assetClass
         * @param assetClass Currency type of withdrawal record, empty by default. Supports querying withdrawal records in main zone and innovation zone on demand. Value range: SPOT, PILOT  SPOT: Main Zone PILOT: Innovation Zone (optional)
         * @return APIlistWithdrawalsRequest
         */
        ...
        /**
         * Set withdrawOrderId
         * @param withdrawOrderId User-defined order number for withdrawal. Default is empty. When not empty, the specified user-defined order number record will be queried (optional)
         * @return APIlistWithdrawalsRequest
         */
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            return listWithdrawalsCall(currency, withdrawId, assetClass, withdrawOrderId, from, to, limit, offset, _callback);
        }
        ...
        public List<WithdrawalRecord> execute() throws ApiException {
            ApiResponse<List<WithdrawalRecord>> localVarResp = listWithdrawalsWithHttpInfo(currency, withdrawId, assetClass, withdrawOrderId, from, to, limit, offset);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<List<WithdrawalRecord>> executeWithHttpInfo() throws ApiException {
            return listWithdrawalsWithHttpInfo(currency, withdrawId, assetClass, withdrawOrderId, from, to, limit, offset);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<WithdrawalRecord>> _callback) throws ApiException {
            return listWithdrawalsAsync(currency, withdrawId, assetClass, withdrawOrderId, from, to, limit, offset, _callback);
        }
    }
    ...
    private okhttp3.Call listDepositsAsync(String currency, Long from, Long to, Integer limit, Integer offset, final ApiCallback<List<DepositRecord>> _callback) throws ApiException {
    ...
    public class APIlistDepositsRequest {
        ...
        /**
         * Set limit
         * @param limit Maximum number of entries returned in the list, limited to 500 transactions (optional, default to 100)
         * @return APIlistDepositsRequest
         */
        ...
        public List<DepositRecord> execute() throws ApiException {
            ApiResponse<List<DepositRecord>> localVarResp = listDepositsWithHttpInfo(currency, from, to, limit, offset);
            return localVarResp.getData();
        }

        /**
         * Execute listDeposits request with HTTP info returned
         * @return ApiResponse&lt;List&lt;DepositRecord&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @param txId Transfer transaction ID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Trading account transfer retrieved successfully </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getTransferCall(String txId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTransferValidateBeforeCall(String txId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'txId' is set
        if (txId == null) {
            throw new ApiException("Missing the required parameter 'txId' when calling getTransfer(Async)");
        }

        okhttp3.Call localVarCall = getTransferCall(txId, _callback);
        return localVarCall;
    }
     ...
     */
    public AccountTransferDetail getTransfer(String txId) throws ApiException {
        ApiResponse<AccountTransferDetail> localVarResp = getTransferWithHttpInfo(txId);
        return localVarResp.getData();
    }
     ...
     * Get the current user&#39;s trading account transfer details using the tx_id returned by the transfer endpoint
     * @param txId Transfer transaction ID (required)
     * @return ApiResponse&lt;AccountTransferDetail&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AccountTransferDetail> getTransferWithHttpInfo(String txId) throws ApiException {
        okhttp3.Call localVarCall = getTransferValidateBeforeCall(txId, null);
        Type localVarReturnType = new TypeToken<AccountTransferDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get trading account transfer (asynchronously)
     * Get the current user&#39;s trading account transfer details using the tx_id returned by the transfer endpoint
     * @param txId Transfer transaction ID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getTransferAsync(String txId, final ApiCallback<AccountTransferDetail> _callback) throws ApiException {
        okhttp3.Call localVarCall = getTransferValidateBeforeCall(txId, _callback);
        Type localVarReturnType = new TypeToken<AccountTransferDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Transfer operation successful </td><td>  -  </td></tr>
     </table>
     */
    ...
    private okhttp3.Call listSubAccountTransfersAsync(String subUid, Long from, Long to, Integer limit, Integer offset, final ApiCallback<List<SubAccountTransferRecordItem>> _callback) throws ApiException {
    ...
    public class APIlistSubAccountTransfersRequest {
        ...
        /**
         * Set subUid
         * @param subUid Sub-account user ID, you can query multiple records separated by &#x60;,&#x60;. If not specified, it will return records of all sub-accounts (optional)
         ...
         * @return List&lt;SubAccountTransferRecordItem&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public List<SubAccountTransferRecordItem> execute() throws ApiException {
            ApiResponse<List<SubAccountTransferRecordItem>> localVarResp = listSubAccountTransfersWithHttpInfo(subUid, from, to, limit, offset);
            return localVarResp.getData();
        }

        /**
         * Execute listSubAccountTransfers request with HTTP info returned
         * @return ApiResponse&lt;List&lt;SubAccountTransferRecordItem&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    /**
     * Transfer between sub-accounts (asynchronously)
     * Supports balance transfers between two sub-accounts under the same main account. You can use either the main account&#39;s API Key or the source sub-account&#39;s API Key to perform the operation
     * @param subAccountToSubAccount  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIgetTransferOrderStatusRequest {
        ...
        /**
         * Set clientOrderId
         * @param clientOrderId Customer-defined ID to prevent duplicate transfers. Can be a combination of letters (case-sensitive), numbers, hyphens &#39;-&#39;, and underscores &#39;_&#39;. Can be pure letters or pure numbers with length between 1-64 characters (optional)
        ...
        /**
         * Set txId
         * @param txId Transfer operation number, cannot be empty at the same time as client_order_id (optional)
         * @return APIgetTransferOrderStatusRequest
         */
    ...
    public class APIlistSubAccountFuturesBalancesRequest {
        ...
        /**
         * Set settle
         * @param settle Query balance of specified settlement currency (optional)
         * @return APIlistSubAccountFuturesBalancesRequest
         */
    ...
    public class APIgetTradeFeeRequest {
        ...
        /**
         * Set currencyPair
         * @param currencyPair Specify currency pair to get more accurate fee settings.  This field is optional. Usually fee settings are the same for all currency pairs. (optional)
        ...
        /**
         * Set settle
         * @param settle Specify the settlement currency of the contract to get more accurate fee settings.  This field is optional. Generally, the fee settings for all settlement currencies are the same. (optional)
         * @return APIgetTradeFeeRequest
         */
    ...
    public class APIgetTotalBalanceRequest {
        ...
        /**
         * Set currency
         * @param currency Target currency type for statistical conversion. Accepts BTC, CNY, USD, and USDT. USDT is the default value (optional, default to &quot;USDT&quot;)
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> Request is valid and successfully returned </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Get list of convertible small balance currencies (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
    ...
    /**
     * Convert small balance currency (asynchronously)
     * 
     * @param convertSmallBalance  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIlistSmallBalanceHistoryRequest {
        ...
        /**
         * Set currency
         * @param currency Currency to convert (optional)
    ...
    public class APIlistPushOrdersRequest {
        ...
        /**
         * Set from
         * @param from Start time for querying records. If not specified, defaults to 7 days before the current time. Unix timestamp in seconds (optional)
         * @return APIlistPushOrdersRequest
         */
        ...
        /**
         * Set to
         * @param to End time for querying records. If not specified, defaults to the current time. Unix timestamp in seconds (optional)
         * @return APIlistPushOrdersRequest
         */
        ...
        /**
         * Set limit
         * @param limit Maximum number of items returned in the list, default value is 100 (optional, default to 100)
         * @return APIlistPushOrdersRequest
         */
        ...
        /**
         * Set transactionType
         * @param transactionType Order type returned in the list: &#x60;withdraw&#x60;, &#x60;deposit&#x60;. Default is &#x60;withdraw&#x60;. (optional, default to &quot;withdraw&quot;)
         * @return APIlistPushOrdersRequest
         */
    ...
    /**
     * Build call for getLowCapExchangeList
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a string array on success </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getLowCapExchangeListCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/wallet/getLowCapExchangeList";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLowCapExchangeListValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        okhttp3.Call localVarCall = getLowCapExchangeListCall(_callback);
        return localVarCall;
    }
     ...
     */
    public List<String> getLowCapExchangeList() throws ApiException {
        ApiResponse<List<String>> localVarResp = getLowCapExchangeListWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<String>> getLowCapExchangeListWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getLowCapExchangeListValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the list of low-liquidity or low-cap tokens (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getLowCapExchangeListAsync(final ApiCallback<List<String>> _callback) throws ApiException {
        okhttp3.Call localVarCall = getLowCapExchangeListValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
