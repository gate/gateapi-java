...
public class SpotApi {
    ...
    /**
     * Query all currency information (asynchronously)
     * When a currency corresponds to multiple chains, you can query the information of multiple chains through the &#x60;chains&#x60; field, such as the charging and recharge status, identification, etc. of the chain
    ...
    /**
     * Query single currency information (asynchronously)
     * 
     * @param currency Currency name (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Query all supported currency pairs (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
    ...
    /**
     * Query single currency pair details (asynchronously)
     * 
     * @param currencyPair Currency pair (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIlistOrderBookRequest {
        ...
        /**
         * Set withId
         * @param withId Return order book update ID (optional, default to false)
         * @return APIlistOrderBookRequest
         */
    ...
    public class APIlistTradesRequest {
        ...
        /**
         * Set limit
         * @param limit Maximum number of items returned in list. Default: 100, minimum: 1, maximum: 1000 (optional, default to 100)
        ...
        /**
         * Set reverse
         * @param reverse Whether to retrieve data less than &#x60;last_id&#x60;. Default returns records greater than &#x60;last_id&#x60;.  Set to &#x60;true&#x60; to trace back market trade records, &#x60;false&#x60; to get latest trades.  No effect when &#x60;last_id&#x60; is not set. (optional, default to false)
         * @return APIlistTradesRequest
         */
    ...
    public class APIlistCandlesticksRequest {
        ...
        /**
         * Set interval
         * @param interval Time interval between data points. Note that &#x60;30d&#x60; represents a calendar month, not aligned to 30 days (optional, default to 30m)
         * @return APIlistCandlesticksRequest
         */
     ...
     * @param currencyPairs Maximum 50 currency pairs per request (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Batch query account fee rates (asynchronously)
     * 
     * @param currencyPairs Maximum 50 currency pairs per request (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIlistSpotAccountBookRequest {
        ...
        /**
         * Set type
         * @param type Query by specified account change type. If not specified, all change types will be included. (optional)
         * @return APIlistSpotAccountBookRequest
         */
        ...
        /**
         * Set code
         * @param code Specify account change code for query. If not specified, all change types are included. This parameter has higher priority than &#x60;type&#x60; (optional)
         * @return APIlistSpotAccountBookRequest
         */
    ...
    /**
     * Batch place orders (asynchronously)
     * Batch order requirements:  1. Custom order field &#x60;text&#x60; must be specified 2. Up to 4 currency pairs per request, with up to 10 orders per currency pair 3. Spot orders and margin orders cannot be mixed; all &#x60;account&#x60; fields in the same request must be identical
     * @param order  (required)
     * @param xGateExptime Specify the expiration time (milliseconds); if the GATE receives the request time greater than the expiration time, the request will be rejected (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param currencyPair Query by specified currency pair. Required for open orders, optional for filled orders (required)
     ...
     * @param tradeQuote In a **unified market** only, specifies the actual quote currency for cancellation; when omitted, all orders matching the other criteria are cancelled (optional)
     ...
     */
    public okhttp3.Call cancelOrdersCall(String currencyPair, String side, String account, String tradeQuote, String actionMode, String xGateExptime, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (tradeQuote != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("trade_quote", tradeQuote));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cancelOrdersValidateBeforeCall(String currencyPair, String side, String account, String tradeQuote, String actionMode, String xGateExptime, final ApiCallback _callback) throws ApiException {
        okhttp3.Call localVarCall = cancelOrdersCall(currencyPair, side, account, tradeQuote, actionMode, xGateExptime, _callback);
        return localVarCall;
    }
     ...
     */
    public List<OrderCancel> cancelOrders(String currencyPair, String side, String account, String tradeQuote, String actionMode, String xGateExptime) throws ApiException {
        ApiResponse<List<OrderCancel>> localVarResp = cancelOrdersWithHttpInfo(currencyPair, side, account, tradeQuote, actionMode, xGateExptime);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<OrderCancel>> cancelOrdersWithHttpInfo(String currencyPair, String side, String account, String tradeQuote, String actionMode, String xGateExptime) throws ApiException {
        okhttp3.Call localVarCall = cancelOrdersValidateBeforeCall(currencyPair, side, account, tradeQuote, actionMode, xGateExptime, null);
     ...
     */
    public okhttp3.Call cancelOrdersAsync(String currencyPair, String side, String account, String tradeQuote, String actionMode, String xGateExptime, final ApiCallback<List<OrderCancel>> _callback) throws ApiException {
        okhttp3.Call localVarCall = cancelOrdersValidateBeforeCall(currencyPair, side, account, tradeQuote, actionMode, xGateExptime, _callback);
        Type localVarReturnType = new TypeToken<List<OrderCancel>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param currencyPair Specify the trading pair to query. This field is required when querying pending order records. This field can be omitted when querying filled order records. (required)
     * @param account Specify query account (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     * @param from Start timestamp in seconds (required)
    ...
    public class APIlistSpotPriceTriggeredOrdersRequest {
        ...
        /**
         * Set market
         * @param market Trading market (optional)
        ...
        /**
         * Set account
         * @param account Trading account type. Unified account must be set to &#x60;unified&#x60; (optional)
         * @return APIlistSpotPriceTriggeredOrdersRequest
         */
