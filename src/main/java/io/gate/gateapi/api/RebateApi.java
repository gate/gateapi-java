...
public class RebateApi {
    ...
    public class APIagencyTransactionHistoryRequest {
        ...
        /**
         * Set currencyPair
         * @param currencyPair Specify the trading pair. If not specified, returns all trading pairs (optional)
    ...
    public class APIrebateBrokerCommissionHistoryRequest {
        ...
        /**
         * Set from
         * @param from Start time of the query record. If not specified, defaults to 30 days before the current time (optional)
         * @return APIrebateBrokerCommissionHistoryRequest
         */
    ...
    /**
     * User obtains rebate information (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     * @param userIdList Query user ID list, separated by commas. If more than 100, only 100 will be returned (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
