...
import io.gate.gateapi.models.LeverageFailedCurrencies;
...
import io.gate.gateapi.models.UserLeverageSetting;
...
public class UnifiedApi {
     ...
     * @param currency Query by specified currency name (required)
    ...
    /**
     * Query maximum borrowable amount for unified account (asynchronously)
     * 
     * @param currency Query by specified currency name (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Query maximum transferable amount for unified account (asynchronously)
     * 
     * @param currency Query by specified currency name (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Batch query maximum transferable amount for unified accounts. Each currency shows the maximum value. After user withdrawal, the transferable amount for all currencies will change (asynchronously)
     * 
     * @param currencies Specify the currency name to query in batches, and support up to 100 pass parameters at a time (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for getUnifiedBorrowableList
     ...
     */
    public okhttp3.Call getUnifiedBorrowableListCall(List<String> currencies, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUnifiedBorrowableListValidateBeforeCall(List<String> currencies, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'currencies' is set
        if (currencies == null) {
            throw new ApiException("Missing the required parameter 'currencies' when calling getUnifiedBorrowableList(Async)");
        }

        okhttp3.Call localVarCall = getUnifiedBorrowableListCall(currencies, _callback);
        return localVarCall;
    }
    ...
    public class APIlistUnifiedLoansRequest {
        ...
        /**
         * Set type
         * @param type Loan type: platform borrowing - platform, margin borrowing - margin (optional)
         * @return APIlistUnifiedLoansRequest
         */
    ...
    public class APIlistUnifiedLoanRecordsRequest {
        ...
        /**
         * Set type
         * @param type Loan record type: borrow - borrowing, repay - repayment (optional)
    ...
    public class APIlistUnifiedLoanInterestRecordsRequest {
        ...
        /**
         * Set type
         * @param type Loan type: platform borrowing - platform, margin borrowing - margin. Defaults to margin if not specified (optional)
         * @return APIlistUnifiedLoanInterestRecordsRequest
         */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Set successfully </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Set unified account mode (asynchronously)
     * Each account mode switch only requires passing the corresponding account mode parameter, and also supports turning on or off the configuration switches under the corresponding account mode during the switch. - When enabling the classic account mode, mode&#x3D;classic &#x60;&#x60;&#x60;  PUT /unified/unified_mode  {  \&quot;mode\&quot;: \&quot;classic\&quot;  } &#x60;&#x60;&#x60; - When enabling the cross-currency margin \&quot;multi_currency\&quot;,  \&quot;settings\&quot;: {  \&quot;usdt_futures\&quot;: true  }  } &#x60;&#x60;&#x60; - When enabling the portfolio margin mode, mode&#x3D;portfolio &#x60;&#x60;&#x60;  PUT /unified/unified_mode  {  \&quot;mode\&quot;: \&quot;portfolio\&quot;,  \&quot;settings\&quot;: {  \&quot;spot_hedge\&quot;: true  }  } &#x60;&#x60;&#x60; - When enabling the single-currency margin mode, mode&#x3D;single_currency &#x60;&#x60;&#x60;  PUT /unified/unified_mode  {  \&quot;mode\&quot;: \&quot;single_currency\&quot;  } &#x60;&#x60;&#x60;
     * @param unifiedModeSet  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Query unified account estimated interest rate (asynchronously)
     * Interest rates fluctuate hourly based on lending depth, so exact rates cannot be provided. When a currency is not supported, the interest rate returned will be an empty string
     * @param currencies Specify currency names for querying in an array, separated by commas, maximum 10 currencies (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Query unified account tiered loan margin (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
    ...
    /**
     * Build call for setUserLeverage
     * @param userLeverageSetting  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call setUserLeverageCall(UserLeverageSetting userLeverageSetting, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = userLeverageSetting;

        // create path and map variables
        String localVarPath = "/unified/leverage/user_setting";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setUserLeverageValidateBeforeCall(UserLeverageSetting userLeverageSetting, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userLeverageSetting' is set
        if (userLeverageSetting == null) {
            throw new ApiException("Missing the required parameter 'userLeverageSetting' when calling setUserLeverage(Async)");
        }

        okhttp3.Call localVarCall = setUserLeverageCall(userLeverageSetting, _callback);
        return localVarCall;
    }
     ...
     * @param userLeverageSetting  (required)
     * @return List&lt;LeverageFailedCurrencies&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public List<LeverageFailedCurrencies> setUserLeverage(UserLeverageSetting userLeverageSetting) throws ApiException {
        ApiResponse<List<LeverageFailedCurrencies>> localVarResp = setUserLeverageWithHttpInfo(userLeverageSetting);
        return localVarResp.getData();
    }
     ...
     * Note the following: - Leverage cannot be changed for currencies with outstanding loans. - A leverage value above a currency&#39;s limit is capped at that limit. - Failures are not rolled back and affect only the currencies that failed. For example, if USDT has an outstanding loan, only the USDT leverage remains unchanged.
     * @param userLeverageSetting  (required)
     * @return ApiResponse&lt;List&lt;LeverageFailedCurrencies&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<LeverageFailedCurrencies>> setUserLeverageWithHttpInfo(UserLeverageSetting userLeverageSetting) throws ApiException {
        okhttp3.Call localVarCall = setUserLeverageValidateBeforeCall(userLeverageSetting, null);
        Type localVarReturnType = new TypeToken<List<LeverageFailedCurrencies>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Set leverage for all of the user&#39;s borrowed currencies (asynchronously)
     * Note the following: - Leverage cannot be changed for currencies with outstanding loans. - A leverage value above a currency&#39;s limit is capped at that limit. - Failures are not rolled back and affect only the currencies that failed. For example, if USDT has an outstanding loan, only the USDT leverage remains unchanged.
     * @param userLeverageSetting  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call setUserLeverageAsync(UserLeverageSetting userLeverageSetting, final ApiCallback<List<LeverageFailedCurrencies>> _callback) throws ApiException {
        okhttp3.Call localVarCall = setUserLeverageValidateBeforeCall(userLeverageSetting, _callback);
        Type localVarReturnType = new TypeToken<List<LeverageFailedCurrencies>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Maximum and minimum currency leverage that can be set (asynchronously)
     * 
     * @param currency Currency (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private okhttp3.Call getUserLeverageCurrencySettingAsync(String currency, final ApiCallback<List<UnifiedLeverageSetting>> _callback) throws ApiException {
    ...
    public class APIgetUserLeverageCurrencySettingRequest {
         ...
         * @return List&lt;UnifiedLeverageSetting&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public List<UnifiedLeverageSetting> execute() throws ApiException {
            ApiResponse<List<UnifiedLeverageSetting>> localVarResp = getUserLeverageCurrencySettingWithHttpInfo(currency);
            return localVarResp.getData();
        }

        /**
         * Execute getUserLeverageCurrencySetting request with HTTP info returned
         * @return ApiResponse&lt;List&lt;UnifiedLeverageSetting&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<UnifiedLeverageSetting>> _callback) throws ApiException {
    ...
    /**
     * Set loan currency leverage (asynchronously)
     * 
     * @param unifiedLeverageSetting  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public class APIgetHistoryLoanRateRequest {
        ...
        /**
         * Set tier
         * @param tier VIP level for the floating rate to be queried (optional)
    ...
    /**
     * Build call for setUnifiedCollateral
     * @param unifiedCollateralReq  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call setUnifiedCollateralCall(UnifiedCollateralReq unifiedCollateralReq, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = unifiedCollateralReq;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setUnifiedCollateralValidateBeforeCall(UnifiedCollateralReq unifiedCollateralReq, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'unifiedCollateralReq' is set
        ...
        okhttp3.Call localVarCall = setUnifiedCollateralCall(unifiedCollateralReq, _callback);
        return localVarCall;
    }
    ...
    public UnifiedCollateralRes setUnifiedCollateral(UnifiedCollateralReq unifiedCollateralReq) throws ApiException {
        ApiResponse<UnifiedCollateralRes> localVarResp = setUnifiedCollateralWithHttpInfo(unifiedCollateralReq);
        return localVarResp.getData();
    }
     ...
     * 
     * @param unifiedCollateralReq  (required)
     * @return ApiResponse&lt;UnifiedCollateralRes&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    public ApiResponse<UnifiedCollateralRes> setUnifiedCollateralWithHttpInfo(UnifiedCollateralReq unifiedCollateralReq) throws ApiException {
        okhttp3.Call localVarCall = setUnifiedCollateralValidateBeforeCall(unifiedCollateralReq, null);
        Type localVarReturnType = new TypeToken<UnifiedCollateralRes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Set collateral currency (asynchronously)
     * 
     * @param unifiedCollateralReq  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
