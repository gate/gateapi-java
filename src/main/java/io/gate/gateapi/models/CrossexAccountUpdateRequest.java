...
public class CrossexAccountUpdateRequest {
    ...
    **/
    ...
    public CrossexAccountUpdateRequest exchangeType(String exchangeType) {
     ...
     /**
     * Exchange (&#x60;BINANCE&#x60; / &#x60;OKX&#x60; / &#x60;GATE&#x60; / &#x60;BYBIT&#x60; / &#x60;KRAKEN&#x60; / &#x60;HYPERLIQUID&#x60; / &#x60;DERIBIT&#x60; / &#x60;CROSSEX&#x60;). When account mode is &#x60;ISOLATED_EXCHANGE&#x60;, the exchange must be specified to adjust futures position mode.
     * @return exchangeType
    **/
    @javax.annotation.Nullable
