...
public class OptionsOrderBook {
    ...
    public OptionsOrderBook id(Long id) {
    ...
    **/
    ...
    public OptionsOrderBook current(Double current) {
    ...
    **/
    ...
    public OptionsOrderBook update(Double update) {
    ...
    **/
    ...
    public OptionsOrderBook asks(List<FuturesOrderBookItem1> asks) {
        
        this.asks = asks;
        return this;
    }

    public OptionsOrderBook addAsksItem(FuturesOrderBookItem1 asksItem) {
    ...
    **/
    ...
    public OptionsOrderBook bids(List<FuturesOrderBookItem1> bids) {
        
        this.bids = bids;
        return this;
    }

    public OptionsOrderBook addBidsItem(FuturesOrderBookItem1 bidsItem) {
    ...
    **/
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OptionsOrderBook optionsOrderBook = (OptionsOrderBook) o;
        return Objects.equals(this.id, optionsOrderBook.id) &&
                Objects.equals(this.current, optionsOrderBook.current) &&
                Objects.equals(this.update, optionsOrderBook.update) &&
                Objects.equals(this.asks, optionsOrderBook.asks) &&
                Objects.equals(this.bids, optionsOrderBook.bids);
    }
    ...
    public String toString() {
        ...
        sb.append("class OptionsOrderBook {\n");
