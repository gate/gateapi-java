...
import io.gate.gateapi.auth.ApiKeyAuth;
import io.gate.gateapi.auth.Authentication;
import io.gate.gateapi.auth.GateApiV4Auth;
import io.gate.gateapi.auth.HttpBasicAuth;
import io.gate.gateapi.auth.HttpBearerAuth;

public class ApiClient {

    private String basePath = "https://api.gateio.ws/api/v4";
    ...
    public ApiClient(String key, String secret) {
        ...
        authentications.put("apiv4", gateApiV4Auth);
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/7.2.132/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.gateio.ws/api/v4
    ...
    /**
     * Helper method to set bearer token for the first HTTP bearer authentication.
     *
     * @param token API key prefix
     */
    public void setBearerToken(String token) {
        ...
        throw new RuntimeException("No HTTP bearer authentication configured!");
    }

    /**
     * Helper method to set key and secret for Gate APIv4 authentication;
     *
     * @param key Gate APIv4 key
     * @param secret Gate APIv4 secret
     */
    public void setApiKeySecret(String key, String secret) {
        for (Authentication auth : authentications.values()) {
            if (auth instanceof GateApiV4Auth) {
                ((GateApiV4Auth) auth).setKeyPair(key, secret);
                return;
            }
        }
        throw new RuntimeException("No Gate APIv4 authentication configured!");
    }
